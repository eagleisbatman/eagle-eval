...
def test_normalize_provider_aliases():
    assert normalize_provider("google", "unused") == "gemini"
    assert normalize_provider("google-gemini", "unused") == "gemini"
...
def test_normalize_provider_infers_from_model_when_missing():
    assert normalize_provider(None, "gemini-3.1-pro") == "gemini"
